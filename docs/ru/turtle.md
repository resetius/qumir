...
В онлайн-песочнице команды Черепахи являются шагами анимации: перемещения, повороты, поднятие/опускание хвоста и сохранение/восстановление состояния возвращают управление интерфейсу. После каждого такого шага поле перерисовывается, поэтому построение линий и фракталов видно постепенно.
