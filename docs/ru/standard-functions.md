...
Эта страница перечисляет встроенные функции и процедуры Qumir, которые доступны без подключения исполнителей. Команды графических исполнителей описаны отдельно: [Черепаха](turtle.md), [Робот](robot.md), [Чертежник](drawer.md), [Рисователь](painter.md). Модули [Комплексные числа](complex.md) и [Клавиатура](keyboard.md) тоже имеют отдельные страницы.
