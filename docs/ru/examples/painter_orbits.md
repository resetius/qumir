...
- `инициализировать` — задаёт начальные координаты, скорости и хвосты частиц
- `шаг_физики` — пересчитывает координаты и обновляет историю хвостов
- `нарисовать` — рисует центральное тело, хвосты, частицы и завершает кадр командой `новый лист`
