...
const TOUR_STEPS = [
  ...
  },
  {
    target: '#btn-run',
    title: 'Запуск',
    text: 'Нажмите Run, чтобы скомпилировать и выполнить программу. Результат появится во вкладке "Вывод" внизу.',
    position: 'top'
  },
  {
    target: '#io-select',
    title: 'Ввод/Вывод',
    text: 'Вкладка "Вывод" — результат работы программы, "Ввод" — данные для программы. Можно добавлять файлы для работы с ними из программы. Файл описания поля робота тоже здесь.',
    position: 'top'
  },
  {
    target: '#btn-share',
